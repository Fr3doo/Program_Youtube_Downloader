...
**Dépendances** : module `utils`. Les libellés du menu sont définis dans
...
- Réutiliser systématiquement les hints de type (voir l'utilisation actuelle de `typing` et `Optional` dans `utils.py`).
